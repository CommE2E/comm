# Creates a target including rust lib and cxxbridge named
# ${NAMESPACE}::${LAST STEM OF PATH}
# <LAST STEM OF PATH> must match the crate name
# ie "some/path/to/myrustcrate" -> "libmyrustcrate.a"
...
function(add_library_rust)
  ...
  if("${_RUST_LIB_PATH}" STREQUAL "")
    message(
        ...
        fix by adding 'PATH <pathToRustlibRoot>'")
  endif()
  ...
  if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/${_RUST_LIB_PATH}/Cargo.toml")
    message(
        FATAL_ERROR
        "The path ${CMAKE_CURRENT_LIST_DIR}/${_RUST_LIB_PATH} does not contain \
        a Cargo.toml")
  endif()
  ...
  add_custom_command(
    ...
    COMMENT "Create cxxbridge target"
    OUTPUT
      ${COMMON_HEADER}
      ${BINDING_HEADER}
      ${BINDING_SOURCE}
