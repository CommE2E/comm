...
impl DatabaseClient {
  ...
  pub async fn append_one_time_prekeys(
    ...
    let mut otk_requests = into_onetime_put_requests(
      &device_id,
      content_onetime_keys,
      OlmAccountType::Content,
    );
    let notif_otk_requests: Vec<WriteRequest> = into_onetime_put_requests(
      &device_id,
      notif_onetime_keys,
    ...
    self
      .client
      .batch_write_item()
      .request_items(one_time_keys_table::NAME, otk_requests)
      .send()
      .await
      .map_err(|e| Error::AwsSdk(e.into()))?;
  ...
  async fn add_device_to_users_table(
    ...
    let content_otk_requests = into_onetime_put_requests(
      &device_id,
      content_onetime_keys,
      OlmAccountType::Content,
    );
    let notif_otk_requests = into_onetime_put_requests(
      &device_id,
      notif_onetime_keys,
      OlmAccountType::Notification,
    );
    ...
    self
      .client
      .batch_write_item()
      .request_items(one_time_keys_table::NAME, content_otk_requests)
      .request_items(one_time_keys_table::NAME, notif_otk_requests)
      .send()
      .await
      .map_err(|e| Error::AwsSdk(e.into()))?;
