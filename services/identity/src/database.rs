...
impl DatabaseClient {
  ...
  pub async fn add_password_user_to_users_table(
    ...
    device_list::add_device(self, &user_id, device_key_upload, None).await?;
  ...
  pub async fn add_password_user_device_to_users_table(
    ...
    let device_exists = device_list::device_exists(
      self,
      user_id.clone(),
      flattened_device_key_upload.device_id_key.clone(),
    )
    ...
    device_list::add_device(self, user_id, flattened_device_key_upload, None)
      .await
  }
  ...
  pub async fn delete_user(
    ...
    device_list::delete_devices_table_rows_for_user(self, &user_id).await?;
