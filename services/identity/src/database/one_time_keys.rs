...
use comm_lib::{
  aws::{
    ddb::types::{AttributeValue, TransactWriteItem, Update},
    DynamoDBError,
  },
  database::{
...
use crate::{
  ...
  ddb_utils::{
    create_one_time_key_partition_key, into_delete_request,
    into_one_time_put_requests, into_one_time_update_and_delete_requests,
    is_transaction_retryable, OlmAccountType,
  },
