...
// This must be named client, so generated code references correct messages
pub mod client {
...
fn get_value(req: &Request<()>, key: &str) -> Option<String> {
...
pub fn auth_intercept(
  ...
  // This must be ran asynchronously without awaiting, use tokio to await in current thread
