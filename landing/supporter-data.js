...
const supportersData: $ReadOnlyArray<Supporter> = [
  {
    id: 'ashoat_tevosyan',
    name: 'Ashoat Tevosyan',
    description: 'Founder of Comm',
    involvement: 'April 2016',
...
const shuffledSupportersData: $ReadOnlyArray<Supporter> =
  _shuffle(supportersData);

const keyedSupporterData: { [key: string]: Supporter } =
  _keyBy('id')(supportersData);

export { shuffledSupportersData, keyedSupporterData };
