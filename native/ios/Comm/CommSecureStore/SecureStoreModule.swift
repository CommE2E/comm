...
public final class SecureStoreModule: NSObject {
  @objc
  func getValueWithKeyAsync(key: String, options: SecureStoreOptions) -> String? {
    do {
  ...
  @objc
  func setValueWithKeyAsync(value: String, key: String, options: SecureStoreOptions) -> Bool {
