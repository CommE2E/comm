...
- (NSString * _Nullable)getValueWithKeyAsyncWithKey:(NSString * _Nonnull)key options:(SecureStoreOptions * _Nonnull)options;
- (BOOL)setValueWithKeyAsyncWithValue:(NSString * _Nonnull)value key:(NSString * _Nonnull)key options:(SecureStoreOptions * _Nonnull)options;
- (nonnull instancetype)init;
@end
