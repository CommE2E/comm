...
@implementation NativeTextInputShadowView {
...
- (instancetype)initWithBridge:(RCTBridge *)bridge
{
  if (self = [super init]) {
    ...
    YGNodeSetMeasureFunc(self.yogaNode, NativeTextInputShadowViewMeasure);
...
static YGSize NativeTextInputShadowViewMeasure(
    YGNodeConstRef node,
    float width,
...
{
  NativeTextInputShadowView *shadowTextView = (__bridge NativeTextInputShadowView *)YGNodeGetContext(node);
