...
@implementation LegacyNativeTextInputView {
  ...
  CustomUITextView *_backedTextInputView;
}
...
- (instancetype)initWithBridge:(RCTBridge *)bridge
{
  ...
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    _backedTextInputView = [[CustomUITextView alloc] initWithFrame:self.bounds];
...
{
  __weak LegacyNativeTextInputView *weakSelf = self;
  [_bridge.uiManager rootViewForReactTag:self.reactTag
                          withCompletion:^(UIView *rootView) {
    LegacyNativeTextInputView *strongSelf = weakSelf;
                            if (rootView) {
...
- (NSString *)getValueAndReset
{
  NSString* prevText = self.backedTextInputView.attributedText.string;
   NSMutableAttributedString *newAttributedText = [self.backedTextInputView.attributedText mutableCopy];
          newAttributedText = [[NSMutableAttributedString alloc]
              initWithString:@""
                  attributes:self.textAttributes.effectiveTextAttributes];
        self.backedTextInputView.attributedText = newAttributedText;
  // TODO: clear selection too
  return prevText;
}
