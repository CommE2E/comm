...
- (void)didReceiveNotificationRequest:(UNNotificationRequest *)request
  ...
  // For notifs that only contain badge update we
  // set BODY to "ENCRYPTED" for internal builds
  // for debugging purposes. So instead of letting
  // such notif go through, we construct another
  // notif that doesn't have a body.
