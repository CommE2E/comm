...
function SelectProtocolDropdown(): React.Node {
  ...
  const options = React.useMemo(() => protocols()
  ...
  return (
    ...
    >
      <View style={styles.dropdownHeader}>
        <TouchableOpacity onPress={onDropdownPress} style={{ flex: 1 }}>
          {dropdownHeader}
        </TouchableOpacity>
        <TouchableOpacity
          onPress={availableProtocols.length > 0 ? onDropdownPress : onInfoPress}
        >
          <Icon
            name={
