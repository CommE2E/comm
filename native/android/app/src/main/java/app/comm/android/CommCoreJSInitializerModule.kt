...
@ReactModule(name = CommCoreJSInitializerModuleSpec.NAME)
class CommCoreJSInitializerModule(reactContext: ReactApplicationContext?) :
  CommCoreJSInitializerModuleSpec(reactContext) {
