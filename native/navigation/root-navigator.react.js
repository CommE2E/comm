...
import {
  ...
  MissingSIWEBackupSecretsRouteName,
} from './route-names.js';
import LoggedOutModal from '../account/logged-out-modal.react.js';
import MissingSIWEBackupSecrets from '../account/registration/missing-siwe-backup-secrets.react.js';
  ...
  return (
    <Root.Navigator screenOptions={defaultScreenOptions}>
      ...
      <Root.Screen
        ...
        component={MissingSIWEBackupSecrets}
      />
    </Root.Navigator>
  );
}
