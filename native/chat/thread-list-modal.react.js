...
import type { ThreadInfo, RawThreadInfo } from 'lib/types/minimally-encoded-thread-permissions-types.js';
...
function ThreadListModal<U: ChatItem>(
  props: Props<U>,
): React.Node {
  const {
