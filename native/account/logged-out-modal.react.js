...
import { useRatchedKeyboardHeight } from '../keyboard/animated-keyboard.js';
...
function LoggedOutModal(props: Props) {
  ...
  const ratchedKeyboardHeightInput = React.useMemo(
    () => ({
  ...
  const keyboardHeightValue = useRatchedKeyboardHeight(
