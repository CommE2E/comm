...
import { loginActionSourceTypes } from 'lib/types/account-types';
  ...
  async onInitialAppLoad() {
    ...
    if (!__DEV__) {
      const actionSource = loggedIn
        ? loginActionSourceTypes.appStartReduxLoggedInButInvalidCookie
        : loginActionSourceTypes.appStartCookieLoggedInButInvalidRedux;
