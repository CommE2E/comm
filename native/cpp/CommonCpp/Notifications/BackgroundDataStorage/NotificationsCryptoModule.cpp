...
NotificationsCryptoModule::CryptoModuleStateHolder::CryptoModuleStateHolder(
    crypto::CryptoModule cryptoModule)
...
std::pair<
    std::string,
    std::unique_ptr<NotificationsCryptoModule::CryptoModuleStateHolder>>
NotificationsCryptoModule::statefulDecrypt(
  ...
  CryptoModuleStateHolder cryptoModuleStateHolder{cryptoModule};
  std::unique_ptr<CryptoModuleStateHolder> cryptoModuleStateHolderPtr =
      std::make_unique<CryptoModuleStateHolder>(
          std::move(cryptoModuleStateHolder));

  return {decryptedData, std::move(cryptoModuleStateHolderPtr)};
}

void NotificationsCryptoModule::flushState(
    std::unique_ptr<CryptoModuleStateHolder> cryptoModuleStateHolder,
    const std::string &callingProcessName) {
  ...
  crypto::CryptoModule cryptoModule =
      *cryptoModuleStateHolder->cryptoModuleState;
