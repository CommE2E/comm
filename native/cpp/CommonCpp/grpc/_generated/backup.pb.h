...
class PakeAuthenticationRequestData PROTOBUF_FINAL :
 ...
 public:
  ...
  enum DataCase {
    kNonce = 1,
    kPakeRegistrationRequest = 2,
    kPakeRegistrationUpload = 3,
    kPakeCredentialRequest = 4,
    kPakeCredentialFinalization = 5,
    kPakeClientMAC = 6,
    DATA_NOT_SET = 0,
  };
  ...
  enum : int {
    ...
    kPakeRegistrationUploadFieldNumber = 3,
    kPakeCredentialRequestFieldNumber = 4,
    kPakeCredentialFinalizationFieldNumber = 5,
    kPakeClientMACFieldNumber = 6,
  };
  // string userID = 7;
  void clear_userid();
...
class CreateNewBackupRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    ...
    kNewCompactionChunkFieldNumber = 2,
  };
...
// bytes nonce = 1;
inline bool PakeAuthenticationRequestData::_internal_has_nonce() const {
  return data_case() == kNonce;
}
inline bool PakeAuthenticationRequestData::has_nonce() const {
  return _internal_has_nonce();
}
inline void PakeAuthenticationRequestData::set_has_nonce() {
  _oneof_case_[0] = kNonce;
}
inline void PakeAuthenticationRequestData::clear_nonce() {
  if (_internal_has_nonce()) {
    data_.nonce_.Destroy(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
    clear_has_data();
  }
}
inline const std::string& PakeAuthenticationRequestData::nonce() const {
  // @@protoc_insertion_point(field_get:backup.PakeAuthenticationRequestData.nonce)
  return _internal_nonce();
}
inline void PakeAuthenticationRequestData::set_nonce(const std::string& value) {
  _internal_set_nonce(value);
  // @@protoc_insertion_point(field_set:backup.PakeAuthenticationRequestData.nonce)
}
inline std::string* PakeAuthenticationRequestData::mutable_nonce() {
  // @@protoc_insertion_point(field_mutable:backup.PakeAuthenticationRequestData.nonce)
  return _internal_mutable_nonce();
}
inline const std::string& PakeAuthenticationRequestData::_internal_nonce() const {
  if (_internal_has_nonce()) {
    return data_.nonce_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PakeAuthenticationRequestData::_internal_set_nonce(const std::string& value) {
  if (!_internal_has_nonce()) {
    clear_data();
    set_has_nonce();
...
inline void PakeAuthenticationRequestData::set_nonce(std::string&& value) {
  // @@protoc_insertion_point(field_set:backup.PakeAuthenticationRequestData.nonce)
  if (!_internal_has_nonce()) {
    clear_data();
    set_has_nonce();
  ...
  // @@protoc_insertion_point(field_set_rvalue:backup.PakeAuthenticationRequestData.nonce)
}
inline void PakeAuthenticationRequestData::set_nonce(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:backup.PakeAuthenticationRequestData.nonce)
}
inline void PakeAuthenticationRequestData::set_nonce(const void* value,
                             size_t size) {
  if (!_internal_has_nonce()) {
    clear_data();
    set_has_nonce();
  ...
  data_.nonce_.Set(
      ...
      GetArena());
  // @@protoc_insertion_point(field_set_pointer:backup.PakeAuthenticationRequestData.nonce)
}
inline std::string* PakeAuthenticationRequestData::_internal_mutable_nonce() {
  if (!_internal_has_nonce()) {
    clear_data();
    set_has_nonce();
    data_.nonce_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
inline std::string* PakeAuthenticationRequestData::release_nonce() {
  // @@protoc_insertion_point(field_release:backup.PakeAuthenticationRequestData.nonce)
  if (_internal_has_nonce()) {
    clear_has_data();
...
inline void PakeAuthenticationRequestData::set_allocated_nonce(std::string* nonce) {
  if (has_data()) {
    clear_data();
  }
  if (nonce != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:backup.PakeAuthenticationRequestData.nonce)
}

// bytes pakeRegistrationRequest = 2;
inline bool PakeAuthenticationRequestData::_internal_has_pakeregistrationrequest() const {
  return data_case() == kPakeRegistrationRequest;
}
inline bool PakeAuthenticationRequestData::has_pakeregistrationrequest() const {
  return _internal_has_pakeregistrationrequest();
}
inline void PakeAuthenticationRequestData::set_has_pakeregistrationrequest() {
  _oneof_case_[0] = kPakeRegistrationRequest;
}
inline void PakeAuthenticationRequestData::clear_pakeregistrationrequest() {
...
inline const std::string& PakeAuthenticationRequestData::pakeregistrationrequest() const {
  // @@protoc_insertion_point(field_get:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
  return _internal_pakeregistrationrequest();
}
inline void PakeAuthenticationRequestData::set_pakeregistrationrequest(const std::string& value) {
  _internal_set_pakeregistrationrequest(value);
  // @@protoc_insertion_point(field_set:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
}
inline std::string* PakeAuthenticationRequestData::mutable_pakeregistrationrequest() {
  // @@protoc_insertion_point(field_mutable:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
  return _internal_mutable_pakeregistrationrequest();
}
inline const std::string& PakeAuthenticationRequestData::_internal_pakeregistrationrequest() const {
  if (_internal_has_pakeregistrationrequest()) {
    return data_.pakeregistrationrequest_.Get();
  }
  return ::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited();
}
inline void PakeAuthenticationRequestData::_internal_set_pakeregistrationrequest(const std::string& value) {
  if (!_internal_has_pakeregistrationrequest()) {
    clear_data();
    set_has_pakeregistrationrequest();
    data_.pakeregistrationrequest_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  data_.pakeregistrationrequest_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void PakeAuthenticationRequestData::set_pakeregistrationrequest(std::string&& value) {
  // @@protoc_insertion_point(field_set:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
  if (!_internal_has_pakeregistrationrequest()) {
    clear_data();
    set_has_pakeregistrationrequest();
  ...
  data_.pakeregistrationrequest_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
}
inline void PakeAuthenticationRequestData::set_pakeregistrationrequest(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  if (!_internal_has_pakeregistrationrequest()) {
    clear_data();
    set_has_pakeregistrationrequest();
  ...
  data_.pakeregistrationrequest_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{},
      ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
}
inline void PakeAuthenticationRequestData::set_pakeregistrationrequest(const void* value,
                             size_t size) {
  if (!_internal_has_pakeregistrationrequest()) {
    clear_data();
    set_has_pakeregistrationrequest();
  ...
  data_.pakeregistrationrequest_.Set(
      ...
      reinterpret_cast<const char*>(value), size),
      GetArena());
  // @@protoc_insertion_point(field_set_pointer:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
}
inline std::string* PakeAuthenticationRequestData::_internal_mutable_pakeregistrationrequest() {
  if (!_internal_has_pakeregistrationrequest()) {
    clear_data();
    set_has_pakeregistrationrequest();
    data_.pakeregistrationrequest_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  }
  return data_.pakeregistrationrequest_.Mutable(
      ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* PakeAuthenticationRequestData::release_pakeregistrationrequest() {
  // @@protoc_insertion_point(field_release:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
  if (_internal_has_pakeregistrationrequest()) {
    clear_has_data();
    return data_.pakeregistrationrequest_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  } else {
    return nullptr;
  }
}
inline void PakeAuthenticationRequestData::set_allocated_pakeregistrationrequest(std::string* pakeregistrationrequest) {
  if (has_data()) {
    clear_data();
  }
  if (pakeregistrationrequest != nullptr) {
    set_has_pakeregistrationrequest();
    data_.pakeregistrationrequest_.UnsafeSetDefault(pakeregistrationrequest);
    ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
    if (arena != nullptr) {
      arena->Own(pakeregistrationrequest);
    }
  }
  // @@protoc_insertion_point(field_set_allocated:backup.PakeAuthenticationRequestData.pakeRegistrationRequest)
}
...
// string userID = 7;
inline void PakeAuthenticationRequestData::clear_userid() {
  userid_.ClearToEmpty();
}
inline const std::string& PakeAuthenticationRequestData::userid() const {
  // @@protoc_insertion_point(field_get:backup.PakeAuthenticationRequestData.userID)
  return _internal_userid();
}
inline void PakeAuthenticationRequestData::set_userid(const std::string& value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:backup.PakeAuthenticationRequestData.userID)
}
inline std::string* PakeAuthenticationRequestData::mutable_userid() {
  // @@protoc_insertion_point(field_mutable:backup.PakeAuthenticationRequestData.userID)
  return _internal_mutable_userid();
}
inline const std::string& PakeAuthenticationRequestData::_internal_userid() const {
  return userid_.Get();
}
inline void PakeAuthenticationRequestData::_internal_set_userid(const std::string& value) {
  
  userid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void PakeAuthenticationRequestData::set_userid(std::string&& value) {
  
  userid_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:backup.PakeAuthenticationRequestData.userID)
}
inline void PakeAuthenticationRequestData::set_userid(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  userid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:backup.PakeAuthenticationRequestData.userID)
}
inline void PakeAuthenticationRequestData::set_userid(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:backup.PakeAuthenticationRequestData.userID)
}
inline std::string* PakeAuthenticationRequestData::_internal_mutable_userid() {
  
  return userid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* PakeAuthenticationRequestData::release_userid() {
  // @@protoc_insertion_point(field_release:backup.PakeAuthenticationRequestData.userID)
  return userid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void PakeAuthenticationRequestData::set_allocated_userid(std::string* userid) {
  if (userid != nullptr) {
  ...
  userid_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), userid,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:backup.PakeAuthenticationRequestData.userID)
}
...
// bytes rawMessage = 1;
inline void WalletAuthenticationRequestData::clear_rawmessage() {
  rawmessage_.ClearToEmpty();
}
inline const std::string& WalletAuthenticationRequestData::rawmessage() const {
  // @@protoc_insertion_point(field_get:backup.WalletAuthenticationRequestData.rawMessage)
  return _internal_rawmessage();
}
inline void WalletAuthenticationRequestData::set_rawmessage(const std::string& value) {
  _internal_set_rawmessage(value);
  // @@protoc_insertion_point(field_set:backup.WalletAuthenticationRequestData.rawMessage)
}
inline std::string* WalletAuthenticationRequestData::mutable_rawmessage() {
  // @@protoc_insertion_point(field_mutable:backup.WalletAuthenticationRequestData.rawMessage)
  return _internal_mutable_rawmessage();
}
inline const std::string& WalletAuthenticationRequestData::_internal_rawmessage() const {
  return rawmessage_.Get();
}
inline void WalletAuthenticationRequestData::_internal_set_rawmessage(const std::string& value) {
  
  rawmessage_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void WalletAuthenticationRequestData::set_rawmessage(std::string&& value) {
  
  rawmessage_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:backup.WalletAuthenticationRequestData.rawMessage)
}
inline void WalletAuthenticationRequestData::set_rawmessage(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  rawmessage_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:backup.WalletAuthenticationRequestData.rawMessage)
}
inline void WalletAuthenticationRequestData::set_rawmessage(const void* value,
    size_t size) {
  
  rawmessage_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:backup.WalletAuthenticationRequestData.rawMessage)
}
inline std::string* WalletAuthenticationRequestData::_internal_mutable_rawmessage() {
  
  return rawmessage_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* WalletAuthenticationRequestData::release_rawmessage() {
  // @@protoc_insertion_point(field_release:backup.WalletAuthenticationRequestData.rawMessage)
  return rawmessage_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void WalletAuthenticationRequestData::set_allocated_rawmessage(std::string* rawmessage) {
  if (rawmessage != nullptr) {
    
  } else {
    
  }
  rawmessage_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), rawmessage,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:backup.WalletAuthenticationRequestData.rawMessage)
}
