...
BlobService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_Put_(BlobService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::CLIENT_STREAMING, channel)
...
::grpc::ClientWriter< ::blob::PutRequest>* BlobService::Stub::PutRaw(::grpc::ClientContext* context, ::google::protobuf::Empty* response) {
  return ::grpc::internal::ClientWriterFactory< ::blob::PutRequest>::Create(channel_.get(), rpcmethod_Put_, context, response);
}

void BlobService::Stub::async::Put(::grpc::ClientContext* context, ::google::protobuf::Empty* response, ::grpc::ClientWriteReactor< ::blob::PutRequest>* reactor) {
  ::grpc::internal::ClientCallbackWriterFactory< ::blob::PutRequest>::Create(stub_->channel_.get(), stub_->rpcmethod_Put_, context, response, reactor);
}

::grpc::ClientAsyncWriter< ::blob::PutRequest>* BlobService::Stub::AsyncPutRaw(::grpc::ClientContext* context, ::google::protobuf::Empty* response, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncWriterFactory< ::blob::PutRequest>::Create(channel_.get(), cq, rpcmethod_Put_, context, response, true, tag);
}

::grpc::ClientAsyncWriter< ::blob::PutRequest>* BlobService::Stub::PrepareAsyncPutRaw(::grpc::ClientContext* context, ::google::protobuf::Empty* response, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncWriterFactory< ::blob::PutRequest>::Create(channel_.get(), cq, rpcmethod_Put_, context, response, false, nullptr);
}
...
BlobService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ClientStreamingHandler< BlobService::Service, ::blob::PutRequest, ::google::protobuf::Empty>(
          [](BlobService::Service* service,
...
::grpc::Status BlobService::Service::Put(::grpc::ServerContext* context, ::grpc::ServerReader< ::blob::PutRequest>* reader, ::google::protobuf::Empty* response) {
  (void) context;
  (void) reader;
  (void) response;
