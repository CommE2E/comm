...
void SQLiteQueryExecutor::restoreFromMainCompaction(
  ...
  for (const auto &tableName : SQLiteQueryExecutor::backedUpTablesAllowlist) {
    copyTableDataUsingAttach(
        SQLiteQueryExecutor::getConnection(), plaintextBackupPath, tableName);
  }
