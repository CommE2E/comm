...
bool add_automatically_retried_column_to_p2p_messages_table(sqlite3 *db) {
  char *error;
  sqlite3_exec(
      db,
      "ALTER TABLE outbound_p2p_messages"
      "  ADD COLUMN automatically_retried INTEGER DEFAULT 0",
      nullptr,
      nullptr,
      &error);
...
bool create_schema(sqlite3 *db) {
  ...
  sqlite3_exec(
      ...
      "	 ciphertext TEXT NOT NULL,"
      "  status TEXT NOT NULL,"
      "	 automatically_retried INTEGER DEFAULT 0,"
      "	 PRIMARY KEY (message_id, device_id)"
      ");"
...
std::vector<std::pair<unsigned int, SQLiteMigration>> migrations{
    {{1, {create_drafts_table, true}},
     ...
     {48, {add_automatically_retried_column_to_p2p_messages_table, true}}}};
...
std::vector<OutboundP2PMessage> SQLiteQueryExecutor::getOutboundP2PMessagesByID(
  ...
  std::vector<SQLiteOutboundP2PMessage> queryResult =
      getAllEntitiesByPrimaryKey<SQLiteOutboundP2PMessage>(
