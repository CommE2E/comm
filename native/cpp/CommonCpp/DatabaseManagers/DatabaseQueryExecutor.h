...
public:
  ...
  getOlmPersistAccountData(bool isContentAccount) const = 0;
  virtual void
  ...
  virtual void
  storeOlmPersistData(bool isContentAccount, crypto::Persist persist) const = 0;
  ...
  getOlmPersistAccountDataWeb(bool isContentAccount) const = 0;
#else
