...
public:
  ...
  getLatestMessageEdit(const std::string &messageID) const override;
  ...
  std::optional<MessageWithMedias>
  getLatestMessageEditWeb(const std::string &messageID) const override;
#else
