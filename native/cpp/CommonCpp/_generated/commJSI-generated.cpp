...
static jsi::Value __hostFunction_CommCoreModuleSchemaCxxSpecJSI_getStoredVersion(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* args, size_t count) {
  return static_cast<CommCoreModuleSchemaCxxSpecJSI *>(&turboModule)->getStoredVersion(rt);
}
