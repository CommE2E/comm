...
public:
  ...
  virtual jsi::Value getLatestMessageEdit(jsi::Runtime &rt, jsi::String messageID) = 0;
...
private:
  ...
  public:
    ...
    jsi::Value getLatestMessageEdit(jsi::Runtime &rt, jsi::String messageID) override {
      static_assert(
          bridging::getParameterCount(&T::getLatestMessageEdit) == 2,
          "Expected getLatestMessageEdit(...) to have 2 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::getLatestMessageEdit, jsInvoker_, instance_, std::move(messageID));
    }
