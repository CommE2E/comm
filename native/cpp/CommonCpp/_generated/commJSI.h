...
public:
  ...
  virtual jsi::Value registerUser(jsi::Runtime &rt, jsi::String username, jsi::String password, jsi::String keyPayload, jsi::String keyPayloadSignature, jsi::String identityPrekey, jsi::String identityPrekeySignature, jsi::String notifPrekey, jsi::String notifPrekeySignature, jsi::Array identityOneTimeKeys, jsi::Array notifOneTimeKeys) = 0;
...
private:
  ...
  public:
    ...
    jsi::Value registerUser(jsi::Runtime &rt, jsi::String username, jsi::String password, jsi::String keyPayload, jsi::String keyPayloadSignature, jsi::String identityPrekey, jsi::String identityPrekeySignature, jsi::String notifPrekey, jsi::String notifPrekeySignature, jsi::Array identityOneTimeKeys, jsi::Array notifOneTimeKeys) override {
      static_assert(
          bridging::getParameterCount(&T::registerUser) == 11,
          "Expected registerUser(...) to have 11 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::registerUser, jsInvoker_, instance_, std::move(username), std::move(password), std::move(keyPayload), std::move(keyPayloadSignature), std::move(identityPrekey), std::move(identityPrekeySignature), std::move(notifPrekey), std::move(notifPrekeySignature), std::move(identityOneTimeKeys), std::move(notifOneTimeKeys));
    }
