...
public:
  ...
  virtual jsi::Value generateAndPublishNotificationsPrekey(jsi::Runtime &rt) = 0;
...
private:
  ...
  public:
    ...
    jsi::Value generateAndPublishNotificationsPrekey(jsi::Runtime &rt) override {
      static_assert(
          bridging::getParameterCount(&T::generateAndPublishNotificationsPrekey) == 1,
          "Expected generateAndPublishNotificationsPrekey(...) to have 1 parameters");

      return bridging::callFromJs<jsi::Value>(
          rt, &T::generateAndPublishNotificationsPrekey, jsInvoker_, instance_);
    }
