...
export type MembershipRowToSave = {
  ...
  +oldRole: string,
  +unread?: boolean,
  +setSubcriptionToBackground?: boolean,
};
...
async function changeRole(
  ...
  const setSubcriptionToBackground = options?.setSubcriptionToBackground;
...
async function saveMemberships({
  ...
  for (const rowToSave of toSave) {
    insertRows.push([
      ...
      rowToSave.role,
      time,
      rowToSave.intent !== 'join' || rowToSave.setSubcriptionToBackground
