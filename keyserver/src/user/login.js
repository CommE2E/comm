...
async function verifyUserLoggedIn(): Promise<IdentityInfo> {
  ...
  if (
    ...
    console.warn(
      ...
      '\nFor keyservers run in Docker refer to',
...
async function registerOrLogIn(
  ...
  try {
    ...
    try {
      ...
      if (userInfo.usingIdentityCredentials === true) {
        console.warn(
          'Please restart nix and provide new user credentials',
          '\nFor keyservers running in the Docker, set different',
