...
> {
  ...
  try {
    ...
    if (dataExistsResponse) {
      return { blobUploadError: 'Holder assignment failed with hash conflict' };
    }
  } catch (e) {
    return {
      blobUploadError: `Holder assignment failed with: ${
