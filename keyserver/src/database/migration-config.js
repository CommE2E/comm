...
const migrations: $ReadOnlyMap<number, () => Promise<void>> = new Map([
      ...
      await dbQuery(
        SQL`
          CREATE TABLE IF NOT EXISTS olm_sessions (
            ...
            pickled_olm_session text CHARACTER SET latin1 COLLATE latin1_bin NOT NULL
      ...
      await dbQuery(
        SQL`
          CREATE TABLE IF NOT EXISTS olm_accounts (
            is_content tinyint(1) NOT NULL,
            pickling_key text CHARACTER SET latin1 COLLATE latin1_bin NOT NULL,
            pickled_olm_account text CHARACTER SET latin1 COLLATE latin1_bin NOT NULL
          ) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
  ...
  [
    ...
    async () => {
      ...
      await dbQuery(
        SQL`
          INSERT INTO olm_accounts (is_content, pickling_key, pickled_olm_account)
          VALUES
            (TRUE, ${pickledContentAccount.picklingKey}, ${pickledContentAccount.pickledAccount}),
