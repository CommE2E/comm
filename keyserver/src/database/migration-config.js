...
async function createOlmAccounts() {
  ...
  await saveOlmAccounts(pickledContentAccount, pickledNotificationsAccount);
}

async function saveOlmAccounts(
...
export { migrations, newDatabaseVersion, createOlmAccounts, saveOlmAccounts };
