  ...
  await dbQuery(
    SQL`
      ...
      CREATE TABLE olm_sessions (
        ...
        pickled_olm_session text CHARACTER SET ascii COLLATE latin1_bin DEFAULT NULL
      ) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;

      CREATE TABLE olm_accounts (
        is_primary tinyint(1) NOT NULL,
        pickling_key text CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL,
        pickled_olm_account text CHARACTER SET latin1 COLLATE latin1_bin DEFAULT NULL
      ) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
...
async function createOlmAccounts() {
  ...
  await dbQuery(
    SQL`
      INSERT INTO olm_accounts (is_primary, pickling_key, pickled_olm_account)
      VALUES
