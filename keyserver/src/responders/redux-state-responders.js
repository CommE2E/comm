...
export const initialReduxStateValidator: TInterface<InitialWebReduxStateResponse> =
  tShape<InitialWebReduxStateResponse>({
...
async function getInitialReduxStateResponder(
...
): Promise<InitialWebReduxStateResponse> {
  ...
  const initialReduxState: InitialWebReduxStateResponse = await promiseAll({
