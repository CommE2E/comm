...
const METADATA_DEFAULT_VALUE = 'default_value';
...
describe('Multiple databases', () => {
  ...
  beforeEach(() => {
    ...
    backupQueryExecutor.setMetadata(METADATA_KEY, METADATA_DEFAULT_VALUE);
  });
  ...
  it('copies content between databases', () => {
    ...
    // not copy content that is not in `tablesAllowlist`
    expect(mainQueryExecutor.getMetadata(METADATA_KEY)).toBe('');
