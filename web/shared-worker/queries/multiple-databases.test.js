...
describe('Multiple databases', () => {
  ...
  beforeEach(() => {
    ...
    mainQueryExecutor = createSQLiteQueryExecutor(
      dbModule,
      MAIN_FILE_PATH,
      false,
    );
    ...
    backupQueryExecutor = createSQLiteQueryExecutor(
      dbModule,
      BACKUP_FILE_PATH,
      false,
    );
  ...
  it('returns correct database version', () => {
    ...
    const migratedQueryExecutor = createSQLiteQueryExecutor(
      dbModule,
      migratedFilePath,
      false,
    );
    ...
    const notMigratedQueryExecutor = createSQLiteQueryExecutor(
      dbModule,
      notMigratedFilePath,
      true,
    );
