...
const olmAPI: OlmAPI = {
  ...
  isKeyserverNotificationsSessionInitialized: proxyToWorker(
  ...
  ephemeralKeyserverNotifsSessionCreator: proxyToWorker(
    'ephemeralKeyserverNotifsSessionCreator',
  ),
  persistEphemeralKeyserverNotifsSession: proxyToWorker(
