...
EMSCRIPTEN_BINDINGS(SQLiteQueryExecutor) {
  ...
  class_<SQLiteQueryExecutor>("SQLiteQueryExecutor")
      ...
      .function("getAllDrafts", &SQLiteQueryExecutor::getAllDrafts, allow_raw_pointers())
      ...
      .function("removeEntries", &SQLiteQueryExecutor::removeEntries, allow_raw_pointers())
      .function("removeAllEntries", &SQLiteQueryExecutor::removeAllEntries)
      .function("getAllEntries", &SQLiteQueryExecutor::getAllEntries, allow_raw_pointers())
      .function(
      ...
      .function(
          ...
          &SQLiteQueryExecutor::resetOutboundP2PMessagesForDevice, allow_raw_pointers())
      .function(
