...
function EditTextMessage(props: Props): React.Node {
  ...
  const saveButtonColors: ButtonColor = {
    ...
    <div className={css.editMessage} style={{ width: props.width }}>
      ...
      <div className={css.bottomRow}>
        ...
        <div className={css.buttons}>
          <Button className={css.saveButton} buttonColor={saveButtonColors}>
            Save (enter)
          </Button>
          <Button onClick={clearEditModal} buttonColor={cancelButtonColor}>
            Cancel (esc)
          </Button>
        </div>
      </div>
