...
goog.exportSymbol('proto.identity.auth.LinkFarcasterDCsAccountRequest', null, global);
 ...
 * @constructor
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.identity.auth.LinkFarcasterDCsAccountRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.identity.auth.LinkFarcasterDCsAccountRequest.displayName = 'proto.identity.auth.LinkFarcasterDCsAccountRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {boolean}
 */
proto.identity.auth.Identity.prototype.getHasFarcasterDcsToken = function() {
 ...
 * @return {!proto.identity.auth.Identity} returns this
 */
proto.identity.auth.Identity.prototype.setHasFarcasterDcsToken = function(value) {
 ...
 * @return {!Object}
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.identity.auth.LinkFarcasterDCsAccountRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.identity.auth.LinkFarcasterDCsAccountRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    farcasterDcsToken: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.identity.auth.LinkFarcasterDCsAccountRequest}
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.identity.auth.LinkFarcasterDCsAccountRequest;
  return proto.identity.auth.LinkFarcasterDCsAccountRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.identity.auth.LinkFarcasterDCsAccountRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.identity.auth.LinkFarcasterDCsAccountRequest}
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.identity.auth.LinkFarcasterDCsAccountRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.identity.auth.LinkFarcasterDCsAccountRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFarcasterDcsToken();
  if (f.length > 0) {
    writer.writeString(
      1,
      f
...
/**
 * optional string farcaster_dcs_token = 1;
 * @return {string}
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.getFarcasterDcsToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.identity.auth.LinkFarcasterDCsAccountRequest} returns this
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.setFarcasterDcsToken = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.getFarcasterId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.identity.auth.LinkFarcasterDCsAccountRequest} returns this
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.setFarcasterId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
