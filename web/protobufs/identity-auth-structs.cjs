...
proto.identity.auth.LinkFarcasterDCsAccountRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    farcasterDcToken: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
/**
 * optional string farcaster_dc_token = 1;
 * @return {string}
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.getFarcasterDcToken = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.identity.auth.LinkFarcasterDCsAccountRequest.prototype.setFarcasterDcToken = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
