...
goog.exportSymbol('proto.identity.unauth.SecondaryDeviceLoginRequest', null, global);
 ...
 * @constructor
 */
proto.identity.unauth.SecondaryDeviceLoginRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.identity.unauth.SecondaryDeviceLoginRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.identity.unauth.SecondaryDeviceLoginRequest.displayName = 'proto.identity.unauth.SecondaryDeviceLoginRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.identity.unauth.SecondaryDeviceLoginRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.identity.unauth.SecondaryDeviceLoginRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    userId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    deviceKeyUpload: (f = msg.getDeviceKeyUpload()) && proto.identity.unauth.DeviceKeyUpload.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.identity.unauth.SecondaryDeviceLoginRequest}
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.identity.unauth.SecondaryDeviceLoginRequest;
  return proto.identity.unauth.SecondaryDeviceLoginRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.identity.unauth.SecondaryDeviceLoginRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.identity.unauth.SecondaryDeviceLoginRequest}
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.identity.unauth.SecondaryDeviceLoginRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.identity.unauth.SecondaryDeviceLoginRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getUserId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.getUserId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.identity.unauth.SecondaryDeviceLoginRequest} returns this
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.setUserId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional DeviceKeyUpload device_key_upload = 2;
 * @return {?proto.identity.unauth.DeviceKeyUpload}
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.getDeviceKeyUpload = function() {
  return /** @type{?proto.identity.unauth.DeviceKeyUpload} */ (
    jspb.Message.getWrapperField(this, proto.identity.unauth.DeviceKeyUpload, 2));
};
 ...
 * @return {!proto.identity.unauth.SecondaryDeviceLoginRequest} returns this
*/
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.setDeviceKeyUpload = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.identity.unauth.SecondaryDeviceLoginRequest} returns this
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.clearDeviceKeyUpload = function() {
  return this.setDeviceKeyUpload(undefined);
};
 ...
 * @return {boolean}
 */
proto.identity.unauth.SecondaryDeviceLoginRequest.prototype.hasDeviceKeyUpload = function() {
  return jspb.Message.getField(this, 2) != null;
};
