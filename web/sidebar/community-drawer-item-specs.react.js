...
const communityDrawerItemSpecs: {
...
function getCommunityDrawerItemSpec(
  tab: string,
): React.ComponentType<HandlerProps> {
  return communityDrawerItemSpecs[tab] ?? communityDrawerItemSpecs['default'];
}

export { getCommunityDrawerItemSpec };
