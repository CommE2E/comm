...
function threadsBelongingToCommunity(
  communityID: string,
...
const threadsBelongingToCommunitySelector: (
  state: AppState,
  ...
  (communityIDFilter: ?string, threadInfos: { +[id: string]: ThreadInfo }) => {
    ...
    return threadsBelongingToCommunity(communityIDFilter, threadInfos);
  },
);
...
export {
  ...
  useOnClickNewThread,
  threadsBelongingToCommunitySelector,
  threadsBelongingToCommunity,
};
