...
/**
 * Native clients before 341 understand only `holder` and `thumbnailHolder`
 * fields, while newer clients understand `blobURI` and `thumbnailBlobURI`.
 * This function formats the multimedia message to be understandable by clients
