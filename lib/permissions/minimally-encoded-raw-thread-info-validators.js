...
import {
  ...
  legacyFarcasterRawThreadInfoValidator,
...
const farcasterRawThreadInfoValidator: TInterface<FarcasterRawThreadInfo> =
  tShape<FarcasterRawThreadInfo>({
    ...legacyFarcasterRawThreadInfoValidator.meta.props,
    minimallyEncoded: tBool(true),
...
const rawThreadInfoValidator: TUnion<
  ThinRawThreadInfo | ThickRawThreadInfo | FarcasterRawThreadInfo,
> = t.union([
  thinRawThreadInfoValidator,
  thickRawThreadInfoValidator,
  farcasterRawThreadInfoValidator,
]);
