...
describe('rolePermissionsToBitmaskHex', () => {
  const permissionsA: ThreadRolePermissionsBlob = {
    add_members: true,
  ...
  it('should successfully encode permissionsA to bitmask', () => {
    const bitmaskA = rolePermissionsToBitmaskHex(permissionsA);
    expect(bitmaskA).toBe(
      '1001001001000001001001b20001001000001001001001001c7dc7d',
    );
  });

  it('should successfully encode permissionsB to bitmask', () => {
    const bitmaskB = rolePermissionsToBitmaskHex(permissionsB);
    expect(bitmaskB).toBe(
