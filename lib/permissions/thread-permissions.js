...
function makePermissionsBlob(
  ...
  if (
    permissionLookup(combinedPermissions, threadPermissions.KNOW_OF) &&
    permissionLookup(combinedPermissions, threadPermissions.MEMBERSHIP)
  ) {
...
function getRoleForPermissions(
  ...
  if (!permissionLookup(permissions, threadPermissions.KNOW_OF)) {
    ...
    Number(inputRole) > 0 &&
    !permissionLookup(permissions, threadPermissions.MEMBERSHIP)
  ) {
    return '0';
  } else {
    return inputRole;
