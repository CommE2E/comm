...
const rolePermissionToBitmaskHex = (permissionString: string): string => {
  const parsedPermissionString: ParsedThreadPermissionString =
    parseThreadPermissionString(permissionString);
  ...
  return permissionVariantBit[lookupKey].toString(16);
};
