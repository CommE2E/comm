...
const decodeRolePermissionBitmask = (bitmask: string): string => {
  ...
  const basePermission = bitmaskInt >> BigInt(4);
  ...
  invariant(
    basePermissionString !== null && basePermissionString !== undefined,
    propagationPrefixString !== null && propagationPrefixString !== undefined,
    filterPrefixString !== null && filterPrefixString !== undefined,
    'invalid bitmask',
  );
