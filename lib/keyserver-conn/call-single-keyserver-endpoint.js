...
let jsonUserInfoHandler = null;
export const registerJsonUserInfoHandler = (
  handler: (CallSingleKeyserverEndpointResponse, Endpoint) => void,
) => {
  jsonUserInfoHandler = handler;
};
...
async function callSingleKeyserverEndpoint(
  ...
  invariant(jsonUserInfoHandler, 'jsonUserInfoHandler should be registered');
  jsonUserInfoHandler(json, endpoint);
