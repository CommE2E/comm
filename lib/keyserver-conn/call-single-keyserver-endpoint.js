...
export type CallSingleKeyserverEndpointResultInfoInterface =
  | 'socket'
  | 'REST'
  // this indicates that there was no call to the keyserver,
  // a call used a different service, e.g. Tunnelbroker
  | 'none';
