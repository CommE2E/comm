...
function CallKeyserverEndpointProvider(props: Props): React.Node {
  ...
  >(new Map());
  const getCallSingleKeyserverEndpoint: GetCallSingleKeyserverEndpoint =
    React.useCallback(
      (keyserverID: string) => {
        let selector =
