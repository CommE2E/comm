...
const updateCalendarCommunityFilter =
  'UPDATE_CALENDAR_COMMUNITY_FILTER' as const;
const clearCalendarCommunityFilter = 'CLEAR_CALENDAR_COMMUNITY_FILTER' as const;
const updateChatCommunityFilter = 'UPDATE_CHAT_COMMUNITY_FILTER' as const;
const clearChatCommunityFilter = 'CLEAR_CHAT_COMMUNITY_FILTER' as const;

const addCommunityActionType = 'ADD_COMMUNITY' as const;
