...
async function fetchRevisionsForEntry(entryID: string) {
  return await fetchJSON('entry_history.php', { 'id': entryID });
}

const restoreEntryActionType = "RESTORE_ENTRY";
async function restoreEntry(entryID: string, sessionID: string) {
