...
function useSetThreadUnreadStatus(): (
  ...
  const streamFarcasterDirectCastRead = useStreamFarcasterDirectCastRead();
  const markFarcasterDirectCastUnread = useMarkFarcasterDirectCastUnread();
    ...
    async (input: UseSetThreadUnreadStatusInput) =>
      threadSpecs[input.threadInfo.type].protocol().setThreadUnreadStatus(
        { input, viewerID },
        {
          ...
          streamFarcasterDirectCastRead,
          markFarcasterDirectCastUnread,
        },
      ),
