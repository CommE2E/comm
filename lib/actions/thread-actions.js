...
const updateFocusedThreadsActionTypes = {
  started: "UPDATE_FOCUSED_THREADS_STARTED",
  success: "UPDATE_FOCUSED_THREADS_SUCCESS",
  failed: "UPDATE_FOCUSED_THREADS_FAILED",
};
async function updateFocusedThreads(
  fetchJSON: FetchJSON,
  focusedThreads: $ReadOnlyArray<string>,
): Promise<void> {
  await fetchJSON('update_focused_threads.php', {
    'focused_threads': focusedThreads,
  });
}
