...
async function changeThreadSettings(
  ...
  const response = await fetchJSON('edit_thread.php', { input: request });
  return {
...
async function newThread(
  ...
  const response = await fetchJSON('new_thread.php', { input: request });
  return {
...
async function joinThread(
  ...
  const response = await fetchJSON('join_thread.php', { input: {
    threadID,
...
async function leaveThread(
  ...
  const response = await fetchJSON('leave_thread.php', { input: { threadID }});
