...
import {
  ...
  type FarcasterMediaUploadHandler,
...
export type MultimediaUploadCallbacks = Partial<{
  ...
  +farcasterMediaUploadHandler: FarcasterMediaUploadHandler,
  +timeout: ?number,
}>;
...
export type FarcasterMediaUploadInput = {
...
export type FarcasterMediaUploadAction = (input: {
  +mediaInput: FarcasterMediaUploadInput,
  +callbacks?: MultimediaUploadCallbacks,
}) => Promise<UploadMultimediaResult>;
