...
function useDeletePasswordAccount(): (
  password: string,
) => Promise<LogOutResult> {
...
function useDeleteWalletAccount(): () => Promise<LogOutResult> {
  const deleteAccount = useDeleteAccount();
...
const registerCallSingleKeyserverEndpointOptions = {
...
const logInCallSingleKeyserverEndpointOptions = {
  timeout: permissionsAndAuthRelatedRequestTimeout,
};
const logIn =
  (
