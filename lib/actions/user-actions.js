...
const sendFriendRequestActionTypes = Object.freeze({
  started: 'SEND_FRIEND_REQUEST_STARTED',
  success: 'SEND_FRIEND_REQUEST_SUCCESS',
  failed: 'SEND_FRIEND_REQUEST_FAILED',
});
async function sendFriendRequest(
  fetchJSON: FetchJSON,
  userIDs: string[],
): Promise<void> {
  await fetchJSON('send_friend_request', { userIDs });
}
