...
function useBaseLogOut(
  ...
  return React.useCallback(
    async (
      ...
      console.log('base Logout started');
      ...
      const identityPromise = (async () => {
        ...
        if (logOutType === 'primary_device') {
          ...
          callIdentityClientLogOut = async () => {
            try {
              await identityClient.logOut(preRequestAuthMetadata);
            } catch (e) {
  ...
  return React.useCallback(
    async preRequestAuthMetadata => {
      ...
      if (usingRestoreFlow) {
        ...
        console.log('isPrimary', { isPrimaryDevice });
...
function usePrimaryDeviceLogOut(): (
  ...
  return React.useCallback(
    async preRequestAuthMetadata => {
      ...
      console.log('usePrimaryDeviceLogOut', { authMetadata });
      ...
      console.log('Calling base log out');
