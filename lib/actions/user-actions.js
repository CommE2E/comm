...
import type { PasswordUpdate, LoggedOutUserInfo } from '../types/user-types.js';
import {
...
const logOutSuccessActionsSet: Set<string> = new Set([
  logOutActionTypes.success,
  deleteKeyserverAccountActionTypes.success,
]);

const logInSuccessActionsSet: Set<string> = new Set([
...
export {
  ...
  logOutSuccessActionsSet,
  logInSuccessActionsSet,
};
