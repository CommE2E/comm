...
const identityGenerateNonceTypes = Object.freeze({
...
const identityPasswordLogInActionTypes = Object.freeze({
  started: 'IDENTITY_PASSWORD_LOG_IN_STARTED',
  success: 'IDENTITY_PASSWORD_LOG_IN_SUCCESS',
  failed: 'IDENTITY_PASSWORD_LOG_IN_FAILED',
});
