...
const getOlmNotifsSessionInitializationDataActionTypes = Object.freeze({
  started: 'GET_OLM_NOTIFS_SESSION_INITIALIZATION_DATA_STARTED',
  success: 'GET_OLM_NOTIFS_SESSION_INITIALIZATION_DATA_SUCCESS',
  failed: 'GET_OLM_NOTIFS_SESSION_INITIALIZATION_DATA_FAILED',
});

const getOlmNotifsSessionInitializationData =
  (
    callServerEndpoint: CallServerEndpoint,
  ): ((
    data: GetOlmNotifsSessionInitializationDataRequest,
