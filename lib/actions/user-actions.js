...
async function deleteAccount(
  ...
  const response = await fetchJSON('delete_account.php', { input: {
    password,
  }});
  return {
    threadInfos: response.cookieChange.threadInfos,
...
async function logIn(
  ...
  const response = await fetchJSON('login.php', { input: {
    usernameOrEmail,
    password,
    watchedIDs,
  }});
...
async function resetPassword(
  ...
  const watchedIDs = threadWatcher.getWatchedIDs();
  const response = await fetchJSON('reset_password.php', { input: {
    code,
    password,
    watchedIDs,
  }});
...
async function changeUserSettings(
  ...
  await fetchJSON('edit_account.php', {
    input: accountUpdate,
  });
