...
function translateLocalMessageInfoToClientDBLocalMessageInfo(
  localMessageInfoID: string,
  localMessageInfo: LocalMessageInfo,
): ClientDBLocalMessageInfo {
  return {
    id: localMessageInfoID,
    send_failed: localMessageInfo.sendFailed?.toString(),
  };
}
