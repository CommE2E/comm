...
export type DispatchRecoveryAttempt = (
  actionTypes: ActionTypes<
    typeof logInActionTypes.started,
    typeof logInActionTypes.success,
    typeof logInActionTypes.failed,
  >,
...
function setCookie(
  ...
  if (response.cookie_change.cookie_invalidated) {
    dispatch({
      ...
      payload: {
        ...
        cookieInvalidated: true,
        currentUserInfo: response.cookie_change.current_user_info,
      },
    });
  } else {
    dispatch({
