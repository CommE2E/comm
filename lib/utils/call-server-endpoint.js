...
import { endpointRequiresAuthentication } from '../types/endpoints.js';
import {
  type Endpoint,
...
async function callServerEndpoint(
  ...
  if (sessionChange) {
    ...
    const temporary = !endpointRequiresAuthentication(endpoint);
    setNewSession(clientSessionChange, error, temporary);
  }
