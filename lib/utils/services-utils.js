...
// Currently, the backup can only be performed when a switch in dev menu is
// enabled. At some point we will remove the switch and start performing
// the backup for all the primary devices. If this flag is true, we're assuming
// that all the primary devices are backed up.
const backupEnabledByDefault = false;
