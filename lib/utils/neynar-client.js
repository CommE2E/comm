...
class NeynarClient {
  ...
  async fetchFollowedFarcasterChannels(fid: string): Promise<NeynarChannel[]> {
    console.log(`fetchFollowedFarcasterChannels called for fid=${fid}`);
  ...
  async fetchFarcasterChannelByID(channelID: string): Promise<?NeynarChannel> {
    console.log(`fetchFarcasterChannelByID called for channelID=${channelID}`);
    const params: { [string]: string } = {
      id: channelID,
    };
  ...
  async fetchFarcasterChannelsByIDs(
    ...
    console.log(
      `fetchFarcasterChannelsByIDs called for channelIDs=${JSON.stringify(
        channelIDs,
      )}`,
    );
    const params: { [string]: string } = {
