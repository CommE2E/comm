...
import { getOutboundP2PMessagesFromAction } from '../utils/peer-to-peer-communication-utils.js';
...
export default function baseReducer<N: BaseNavInfo, T: BaseAppState<N>>(
  ...
  const outboundP2PMessages: $ReadOnlyArray<OutboundP2PMessage> =
    getOutboundP2PMessagesFromAction(action, auxUserStore, currentUserInfo);
