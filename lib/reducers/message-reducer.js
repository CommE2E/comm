    ...
    _map((messageInfo: RawMessageInfo) => {
      ...
      if (
        ...
        const isThick = threadTypeIsThick(
          threadInfos[messageInfo.threadID].type,
        );
        if (currentMessageInfo && currentMessageInfo.localID) {
          ...
          // It is also possible that this is a failed thick thread message,
          // in which case we shouldn't remove the localID, because this
          // message doesn't have an ID yet.
