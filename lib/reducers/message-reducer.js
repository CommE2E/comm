...
function reduceMessageStore(
  ...
  if (
    ...
    // TODO: double check reaction messages when testing
    messageStoreOperations.push({
      type: 'remove_local_message_infos',
      payload: {
        ids: [payload.localID],
    ...
    const localMessageIDsToRemove = _omit(messageIDsToPrune)(
      messageStore.local,
    );
    ...
    const messageStoreOperations = [
      ...
      {
        type: 'remove_local_message_infos',
        payload: { ids: localMessageIDsToRemove },
      },
    ];
    ...
    // @ginsu + @will double check replace_local_message_info at the end
    const messageStoreOperations = [
      {
        type: 'replace',
      ...
      {
        type: 'replace_local_message_info',
        payload: { id: localID, localMessageInfo: {} },
      },
    ];
