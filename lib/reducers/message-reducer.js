...
import type { RawImagesMessageInfo } from '../types/message/images';
import type { RawMediaMessageInfo } from '../types/message/media';
...
function mergeNewMessages(
  ...
  for (let threadID in oldMessageStore.threads) {
    ...
    for (let id of thread.messageIDs) {
...
function filterByNewThreadInfos(
  ...
  for (let threadID in messageStore.threads) {
    ...
    for (let id of messageStore.threads[threadID].messageIDs) {
