      ...
      for (const singleMedia of message.media) {
        if (singleMedia.id !== currentMediaID) {
          ...
          if (singleMedia.blobURI) {
            const { holder: _, ...rest } = mediaUpdate;
            ...
            const { blobURI: _, ...rest } = mediaUpdate;
            media.push({ ...singleMedia, ...rest });
          }
          replaced = true;
        } else if (
          ...
          if (singleMedia.blobURI) {
            const { holder: _1, thumbnailHolder: _2, ...rest } = mediaUpdate;
            media.push({ ...singleMedia, ...rest });
          } else {
            invariant(
              singleMedia.holder,
            ...
            const { blobURI: _1, thumbnailBlobURI: _2, ...rest } = mediaUpdate;
            media.push({ ...singleMedia, ...rest });
          }
          replaced = true;
        } else if (
