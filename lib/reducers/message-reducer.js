...
import {
  ...
  createReplaceMessageStoreThreadsOperation,
...
function freshMessageStore(
  ...
  const messageStoreOperations = [
    ...
    ...createReplaceMessageStoreThreadsOperation(threads, threadInfos),
...
function reassignMessagesToRealizedThreads(
  ...
  if (Object.keys(updatedThreads).length > 0) {
    messageStoreOperations.push(
      ...createReplaceMessageStoreThreadsOperation(updatedThreads, threadInfos),
    );
  }
...
function mergeNewMessages(
  ...
  const dbOps = [
    ...newMessageOps,
    ...createReplaceMessageStoreThreadsOperation(filteredThreads, threadInfos),
  ];
