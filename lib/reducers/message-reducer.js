...
function reduceMessageStore(
  ...
  if (
    ...
    // For composable DM messages, we pass `rawMessageInfos` to update
    // the replies count, but we want to ignore it here, updating the message
    // store is done using dedicated actions.
