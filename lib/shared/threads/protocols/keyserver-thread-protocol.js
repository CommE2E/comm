...
const keyserverThreadProtocol: ThreadProtocol<MemberInfoSansPermissions> =
  Object.freeze({
    ...
    changeThreadMemberRoles: async (
      ...
      const promise = utils.keyserverCall({
        threadInfo,
        memberIDs,
        newRole,
      });
    ...
    pinMessage: async (
      ...
      const promise = utils.keyserverToggleMessagePin({
        messageID: input.messageID,
        action: input.action,
      });
      void utils.dispatchActionPromise(toggleMessagePinActionTypes, promise);
      await promise;
    },
    ...
    fetchPinnedMessages: async (
      ...
      return await utils.keyserverFetchPinnedMessages({
        threadID: input.threadInfo.id,
      });
    },
    ...
    supportsSendingVideos: true,
    canSendMultipleMedia: true,
