...
const dmThreadProtocol: ThreadProtocol<MinimallyEncodedThickMemberInfo> =
  Object.freeze({
    ...
    presentationDetails: {
      ...
      protocolIcon: 'lock',
      description:
        'This is a Comm DM, a secure, end-to-end encrypted chat that is stored locally on your device for maximum privacy.',
    },
    ...
    doesUserSupportThreadProtocol: (
      userID: string,
      utils: UsersSupportProtocolUtils,
    ) => {
      return userHasDeviceList(userID, utils.auxUserInfos);
    },

    protocolName: 'Comm DM',
  });
