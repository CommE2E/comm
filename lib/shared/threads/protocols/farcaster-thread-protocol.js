...
const farcasterThreadProtocol: ThreadProtocol<MemberInfoSansPermissions> = {
  ...
  presentationDetails: {
    ...
    description:
      'This is a Farcaster DC—a direct conversation that syncs with your Farcaster account and appears in both Comm and Farcaster apps.',
  },
