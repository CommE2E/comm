...
export type DeleteMessageUtils = {
  ...
  +dispatchActionPromise: DispatchActionPromise,
  +farcasterDeleteMessage: DeleteFarcasterMessageInput => Promise<void>,
  +dispatch: Dispatch,
};
...
export type FetchPinnedMessagesUtils = {
  +keyserverFetchPinnedMessages: FetchPinnedMessagesRequest => Promise<FetchPinnedMessagesResult>,
  +fetchMessage: (messageID: string) => Promise<?RawMessageInfo>,
};
