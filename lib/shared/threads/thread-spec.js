...
import type { AuxUserInfos, AuxUserStore } from '../../types/aux-user-types';
import type {
  CalendarQuery,
  CreateEntryInfo,
  CreateEntryPayload,
...
export type UsersSupportProtocolUtils = {
  +auxUserInfos: AuxUserInfos,
};

export type ThreadIcon = 'lock' | 'server';

export type ProtocolName = 'Comm DM' | 'Farcaster DC' | 'Keyserver';
export type ProtocolIdentifier = 'dm' | 'dc' | 'keyserver';
export const protocolIdentifierValidator: TEnums = t.enums.of([
  'dm',
  'dc',
  'keyserver',
]);
