...
describe('chatMentionRegex', () => {
  ...
  it('We do expect to match raw chat mention with escaped squared closing brackets.', () => {
    expect('@[[256|1:bar \\] \\]]]').toMatch(chatMentionRegex);
  });

  it('We do not expect to match raw chat mention with escaped squared closing brackets.', () => {
  ...
  it('We do not expect an invalid raw chat mention format.', () => {
