...
import { assertThickThreadType } from '../../types/thread-types-enum.js';
import {
...
function useAddDMThreadMembers(): (
  ...
  return React.useCallback(
    async (newMemberIDs: $ReadOnlyArray<string>, threadInfo: ThreadInfo) => {
      ...
      const viewerToThreadMembersOperation: DMAddViewerToThreadMembersOperation =
        {
      ...
      const viewerOperationSpecification: OutboundDMOperationSpecification = {
        ...
        op: viewerToThreadMembersOperation,
        recipients: {
          type: 'some_users',
