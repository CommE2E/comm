...
function useJoinCommunity(params: UseJoinCommunityParams): {
  +join: () => mixed,
  +ongoingJoinData: ?OngoingJoinData,
  +setOngoingJoinData: SetState<?OngoingJoinData>,
  ...
  const [ongoingJoinData, setOngoingJoinData] =
    React.useState<?OngoingJoinData>(null);
  ...
  }, [communityID, keyserverID, setLinkStatus, threadID]);
  ...
  return React.useMemo(
    ...
    [createJoinPromise, ongoingJoinData, step],
  );
}
