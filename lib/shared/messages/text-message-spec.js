...
import { composableMessageNotifPrefix } from '../../types/message-types.js';
import {
...
import { useModifyFarcasterMembershipInput } from '../farcaster/farcaster-api.js';
import { useRefreshFarcasterConversation } from '../farcaster/farcaster-hooks.js';
import {
  type ASTNode,
  type SingleASTNode,
...
export const textMessageSpec: TextMessageSpec = Object.freeze({
  ...
  notificationCollapseKey(
    ...
    return rawMessageInfo.id
      ? joinResult(composableMessageNotifPrefix, rawMessageInfo.id)
      : null;
  },
