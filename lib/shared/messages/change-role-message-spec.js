...
> = Object.freeze({
  ...
  robotext(
    ...
    const thread = threadInfo ?? parentThreadInfo;
    invariant(thread, 'ThreadInfo should be set for CHANGE_ROLE message');

    const threadRoleName = thread.roles[messageInfo.newRole]?.name;
