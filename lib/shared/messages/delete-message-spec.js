...
import { messageNotifyTypes } from './message-spec.js';
...
> = Object.freeze({
  ...
  notificationCollapseKey(rawMessageInfo: RawDeleteMessageInfo): string {
    return joinResult(
      composableMessageNotifPrefix,
      rawMessageInfo.targetMessageID,
    );
  },

  getMessageNotifyType: async () => messageNotifyTypes.RESCIND,
