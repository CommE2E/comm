...
import { getProtocolByThreadID } from '../threads/protocols/thread-protocols.js';
...
export const removeMembersMessageSpec: RemoveMembersMessageSpec = Object.freeze(
  {
    ...
    getMessageNotifyType: async (rawMessageInfo: RawRemoveMembersMessageInfo) =>
      getProtocolByThreadID(rawMessageInfo.threadID)
