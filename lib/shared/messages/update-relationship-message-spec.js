...
} from '../../types/messages/update-relationships.js';
import { rawUpdateRelationshipMessageInfoValidator } from '../../types/messages/update-relationships.js';
  ...
  Object.freeze({
    ...
    robotext(
      ...
      if (messageInfo.operation === 'request_sent') {
        ...
        // TODO (atul): See if we can do something better here.
    ...
    shimUnsupportedMessageInfo(
      ...
      if (rawMessageInfo.type === messageTypes.LEGACY_UPDATE_RELATIONSHIP) {
        ...
        hasMinCodeVersion(platformDetails, { native: 9999 })
      ) {
        return rawMessageInfo;
      } else if (
        rawMessageInfo.type === messageTypes.UPDATE_RELATIONSHIP &&
    ...
    notificationCollapseKey(
      ...
      return joinResult(rawMessageInfo.type, rawMessageInfo.operation);
    },
