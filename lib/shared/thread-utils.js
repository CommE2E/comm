...
function threadIsPersonalChat(threadInfo: ThreadInfo) {
  return threadInfo.members.length === 1;
}

function threadIsTwoPersonChat(threadInfo: ThreadInfo) {
  return threadInfo.members.length === 2;
}

function threadIsNamed(threadInfo: ThreadInfo) {
  // TODO: allow unnamed threads
  return true;
}
