...
import {
  ...
  ThreadPermissionNotAffectedByBlock,
...
const permissionsDisabledByBlock: Set<ThreadPermission> = new Set(
  values(threadPermissionsDisabledByBlock),
);

const disabledPermissions: ThreadPermissionsInfo = values(
  threadPermissionsDisabledByBlock,
).reduce(
...
function useExistingThreadInfoFinder(
  ...
  return React.useCallback(
    (params: ExistingThreadInfoFinderParams): ?ThreadInfo => {
      ...
      return {
        ...updatedThread,
        currentUser: updatedThread.currentUser,
      };
    },
