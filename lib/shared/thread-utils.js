...
type RoleAndMemberCountType = {
  [roleName: string]: number,
};

function getRoleMemberCountsForCommunity(
  threadInfo: ThreadInfo,
): RoleAndMemberCountType {
  ...
  const roleNamesToMemberCount: RoleAndMemberCountType = {};
...
type RoleUserSurfacedPermissions = {
  [roleName: string]: $ReadOnlyArray<UserSurfacedPermission>,
};
function getRoleUserSurfacedPermissions(
  threadInfo: ThreadInfo,
): RoleUserSurfacedPermissions {
  const roleNamesToPermissions: RoleUserSurfacedPermissions = {};
...
export {
  ...
  getRoleMemberCountsForCommunity,
  getRoleUserSurfacedPermissions,
};
