...
import type { ThreadType } from '../types/thread-types';
...
function createPendingThread(
  ...
  const rawThreadInfo = {
    ...
    name: null,
    description: null,
    color: generatePendingThreadColor(memberIDs, viewerID),
    creationTime: now,
    parentThreadID: null,
    members: [
      {
...
function createPendingThreadItem(
  ...
  const threadInfo = createPendingThread(viewerID, threadTypes.PERSONAL, [
    user,
  ]);
...
function rawThreadInfoFromServerThreadInfo(
  ...
  const rawThreadInfo = {
    ...
    currentUser,
    sourceMessageID: serverThreadInfo.sourceMessageID,
  };
...
function threadInfoFromRawThreadInfo(
  ...
  return {
    ...
    sourceMessageID: rawThreadInfo.sourceMessageID,
  };
}
