...
function useResolvedThreadAvatar(
  ...
  usernameFIDAndChannel: ?UsernameFIDAndChannel,
): ResolvedClientAvatar {
  const username = usernameFIDAndChannel?.username;
  const farcasterID = usernameFIDAndChannel?.farcasterID;
  const fcChannelID = usernameFIDAndChannel?.fcChannelID;
  ...
  // If `usernameFIDAndChannel` contains information about the display user AND
  // a Farcaster channel ID, the former should supersede the latter
