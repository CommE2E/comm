...
import { defaultAnonymousUserEmojiAvatar as message } from './avatar-utils.js';
...
import { useStringForUser } from '../hooks/names-cache.js';
...
export type FetchMessagesFromDBType = (
  threadID: string,
  limit: number,
  offset: number,
) => Promise<FetchMessageInfosPayload>;

const fetchMessagesFromDB: FetchMessagesFromDBType = async (
  threadID: string,
  limit: number,
  offset: number,
) => {
