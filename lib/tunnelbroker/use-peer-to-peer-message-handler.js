  ...
  return React.useCallback(
    async (decryptedMessageContent: string, senderInfo: SenderInfo) => {
      ...
      if (
        ...
        } else if (!relyingOnAuthoritativeKeyserver) {
          // When relying on authritative keyserver, it takes care of sending
          // appropriate update that removes peer user from Redux user stores
          dispatch({
