...
declare module "lodash" {
  ...
  declare type Lodash = {|
    ...
    flow: ((funcs: $ReadOnlyArray<Function>) => Function) & (<A, B>(f1: (a: A) => B) => (a: A) => B) & (<A, B, C>(f1: (a: A) => B, f2: (b: B) => C) => (a: A) => C) & (<A, B, C, D>(f1: (a: A) => B, f2: (b: B) => C, f3: (c: C) => D) => (a: A) => D);
    flowRight: ((funcs: $ReadOnlyArray<Function>) => Function) & (<A, B>(f1: (a: A) => B) => (a: A) => B) & (<A, B, C>(f1: (b: B) => C, f2: (a: A) => B) => (a: A) => C) & (<A, B, C, D>(f1: (c: C) => D, f2: (b: B) => C, f3: (a: A) => B) => (a: A) => D);
...
declare module "lodash/fp" {
  ...
  declare type Lodash = {|
    ...
    defaultTo:
      ...
      & (<T1: number, T2>(defaultValue: T2, value: T1) => T1 | T2);
    flow: ((funcs: $ReadOnlyArray<Function>) => Function) & (<A, B>(f1: (a: A) => B) => (a: A) => B) & (<A, B, C>(f1: (a: A) => B, f2: (b: B) => C) => (a: A) => C) & (<A, B, C, D>(f1: (a: A) => B, f2: (b: B) => C, f3: (c: C) => D) => (a: A) => D);
    pipe: ((funcs: $ReadOnlyArray<Function>) => Function) & (<A, B>(f1: (a: A) => B) => (a: A) => B) & (<A, B, C>(f1: (a: A) => B, f2: (b: B) => C) => (a: A) => C) & (<A, B, C, D>(f1: (a: A) => B, f2: (b: B) => C, f3: (c: C) => D) => (a: A) => D);
    flowRight: ((funcs: $ReadOnlyArray<Function>) => Function) & (<A, B>(f1: (a: A) => B) => (a: A) => B) & (<A, B, C>(f1: (b: B) => C, f2: (a: A) => B) => (a: A) => C) & (<A, B, C, D>(f1: (c: C) => D, f2: (b: B) => C, f3: (a: A) => B) => (a: A) => D);
    compose: ((funcs: $ReadOnlyArray<Function>) => Function) & (<A, B>(f1: (a: A) => B) => (a: A) => B) & (<A, B, C>(f1: (b: B) => C, f2: (a: A) => B) => (a: A) => C) & (<A, B, C, D>(f1: (c: C) => D, f2: (b: B) => C, f3: (a: A) => B) => (a: A) => D);
    identity<T>(value: T): T;
    iteratee(func: any): Function;
    matches:
      & ((source: Object) => ((object: Object) => boolean))
