...
} from '../../shared/farcaster/farcaster-messages-types.js';
...
export type NewFarcasterMessage = {
  +type: 'NewFarcasterMessage',
  +message: FarcasterMessage,
};

export const newFarcasterMessageValidator: TInterface<NewFarcasterMessage> =
  tShape<NewFarcasterMessage>({
    type: tString('NewFarcasterMessage'),
    message: farcasterMessageValidator,
  });

export type FarcasterInboxStatus = {
  +type: 'FarcasterInboxStatus',
  +unreadConversationIds: $ReadOnlyArray<string>,
  +readConversationIds: $ReadOnlyArray<string>,
};

export const farcasterInboxStatusValidator: TInterface<FarcasterInboxStatus> =
  tShape<FarcasterInboxStatus>({
    type: tString('FarcasterInboxStatus'),
    unreadConversationIds: t.list(t.String),
    readConversationIds: t.list(t.String),
  });
