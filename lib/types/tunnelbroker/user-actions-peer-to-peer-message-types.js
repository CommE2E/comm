...
export type AddKeyserverMessage = {
  +type: 'ADD_KEYSERVER',
  +keyserverAdminUserID: string,
  +urlPrefix: string,
};
export const addKeyserverMessageValidator: TInterface<AddKeyserverMessage> =
  tShape<AddKeyserverMessage>({
    type: tString(userActionsP2PMessageTypes.ADD_KEYSERVER),
    keyserverAdminUserID: t.String,
    urlPrefix: t.String,
  });

export type RemoveKeyserverMessage = {
  +type: 'REMOVE_KEYSERVER',
  +keyserverAdminUserID: string,
};
export const removeKeyserverMessageValidator: TInterface<RemoveKeyserverMessage> =
  tShape<RemoveKeyserverMessage>({
    type: tString(userActionsP2PMessageTypes.REMOVE_KEYSERVER),
    keyserverAdminUserID: t.String,
  });
...
export const userActionP2PMessageValidator: TUnion<UserActionP2PMessage> =
  t.union([
    ...
    addKeyserverMessageValidator,
    removeKeyserverMessageValidator,
  ]);
