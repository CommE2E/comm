...
import { theRealMixedThreadInfoValidator } from '../permissions/minimally-encoded-raw-thread-info-validators.js';
...
export const fullStateSyncActionType = 'FULL_STATE_SYNC' as const;
...
const serverFullStateSyncValidator = tShape<ServerFullStateSync>({
  ...
  threadInfos: t.dict(tID, theRealMixedThreadInfoValidator),
...
export const authErrorServerSocketMessageValidator: TInterface<AuthErrorServerSocketMessage> =
  tShape<AuthErrorServerSocketMessage>({
    ...
    responseTo: t.Number,
    message: t.String,
    sessionChange: tShape<SessionChange>({
      cookie: t.String,
...
export type ConnectionInfo = {
  ...
  +activeSessionRecovery: void | null | RecoveryFromReduxActionSource,
};
