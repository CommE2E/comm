...
export const serverRequestTypes = Object.freeze({
  ...
  ENTRY_POLL_PUSH_INCONSISTENCY: 5,
  CHECK_STATE: 6,
});
...
export type EntryPollPushInconsistencyClientResponse = {|
  type: 5,
  platformDetails: PlatformDetails,
...
type CheckStateServerRequest = {|
  type: 6,
  hashesToCheck: {[key: string]: string},
|};
...
export const serverRequestPropType = PropTypes.oneOfType([
  ...
  PropTypes.shape({
    ...
    hashesToCheck: PropTypes.objectOf(PropTypes.string).isRequired,
  }),
]);
