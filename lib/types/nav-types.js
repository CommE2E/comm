...
import type { SelectedUserInfo } from './user-types.js';
import { selectedUserInfoValidator } from './user-types.js';
...
export type WebNavInfo = {
  ...
  +selectedUserList?: $ReadOnlyArray<SelectedUserInfo>,
...
>({
  ...
  selectedUserList: t.maybe(t.list(selectedUserInfoValidator)),
