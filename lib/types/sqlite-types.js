...
export type SQLiteAPI = {
  ...
  +getDatabaseVersion: (dbID: DatabaseIdentifier) => Promise<number>,
  +getSyncedMetadata: (
    entryName: string,
    dbID: DatabaseIdentifier,
  ) => Promise<?string>,
  +getHolders: (dbID: DatabaseIdentifier) => Promise<StoredHolders>,
  +getAuxUserIDs: (dbID: DatabaseIdentifier) => Promise<Array<string>>,
