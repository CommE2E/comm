...
export type BaseAction =
  ...
  |} | {|
    type: typeof updateFocusedThreadsActionTypes.started,
    loadingInfo: LoadingInfo,
  |} | {|
    type: typeof updateFocusedThreadsActionTypes.failed,
    error: true,
    payload: Error,
    loadingInfo: LoadingInfo,
  |} | {|
    type: typeof updateFocusedThreadsActionTypes.success,
    payload: UpdateFocusedThreadsResult,
    loadingInfo: LoadingInfo,
  |};
