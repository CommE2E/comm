...
import type { UpdateActivityResult } from '../actions/ping-actions';
...
export type BaseAction =
  ...
  |} | {|
    ...
    loadingInfo: LoadingInfo,
  |} | {|
    type: typeof setIOSDeviceTokenActionTypes.started,
    loadingInfo: LoadingInfo,
  |} | {|
    type: typeof setIOSDeviceTokenActionTypes.failed,
    error: true,
    payload: Error,
    loadingInfo: LoadingInfo,
  |} | {|
    type: typeof setIOSDeviceTokenActionTypes.success,
    payload: string,
    loadingInfo: LoadingInfo,
  |};
