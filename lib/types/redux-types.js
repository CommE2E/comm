...
export type BaseAppState<
  NavInfo: BaseNavInfo,
  KeyserverInfoType: KeyserverInfo,
> = {
  navInfo: NavInfo,
  ...
  +keyserverStore: KeyserverStore<KeyserverInfoType>,
  ...
};
...
export type NativeAppState = BaseAppState<*, NativeKeyserverInfo> & {
  sessionID?: void,
  ...
};
export type WebAppState = BaseAppState<*, WebKeyserverInfo> & {
  sessionID: ?string,
