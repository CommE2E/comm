...
export type BaseAction =
  ...
  | {
      +type: 'CHANGE_USER_PASSWORD_SETTINGS_STARTED',
      +payload?: void,
      +loadingInfo: LoadingInfo,
    }
  | {
      +type: 'CHANGE_USER_PASSWORD_SETTINGS_FAILED',
      +error: true,
      +payload: Error,
      +loadingInfo: LoadingInfo,
    }
  | {
      +type: 'CHANGE_USER_PASSWORD_SETTINGS_SUCCESS',
      +payload?: void,
      +loadingInfo: LoadingInfo,
    }
  | {
