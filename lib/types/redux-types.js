...
export type BaseAction =
  ...
  | {
      +type: 'GET_OLM_NOTIFS_SESSION_INITIALIZATION_DATA_STARTED',
      +loadingInfo?: LoadingInfo,
      +payload?: void,
    }
  | {
      +type: 'GET_OLM_NOTIFS_SESSION_INITIALIZATION_DATA_SUCCESS',
      +payload: GetOlmNotifsSessionInitializationDataResponse,
      +loadingInfo: LoadingInfo,
    }
  | {
      +type: 'GET_OLM_NOTIFS_SESSION_INITIALIZATION_DATA_FAILED',
      +error: true,
      +payload: Error,
      +loadingInfo: LoadingInfo,
    };
