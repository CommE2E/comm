...
import type { CreateUserDataBackupPayload } from '../actions/backup-actions.js';
import type {
...
import type { RestoreProtocolResult } from '../actions/user-actions.js';
import type {
...
export type BaseAction = $ReadOnly<{
  ...
  ...
    ...
    | {
        +type: 'INCREMENT_COLD_START_COUNT',
        +payload: void,
      }
    | {
    ...
    | {
        +type: 'CREATE_USER_DATA_BACKUP_STARTED',
        +loadingInfo?: LoadingInfo,
        +payload: { +ownDevicesWithoutBackup: $ReadOnlyArray<string> },
      }
    | {
        +type: 'CREATE_USER_DATA_BACKUP_SUCCESS',
        +payload: CreateUserDataBackupPayload,
        +loadingInfo: LoadingInfo,
      }
    | {
        +type: 'CREATE_USER_DATA_BACKUP_FAILED',
        +error: true,
        +payload: Error,
        +loadingInfo: LoadingInfo,
      }
    ...
    | {
        +type: 'SEND_DELETE_MESSAGE_STARTED',
        +loadingInfo?: LoadingInfo,
        +payload?: void,
      }
    | {
        +type: 'SEND_DELETE_MESSAGE_SUCCESS',
        +payload: DeleteMessageResponse,
        +loadingInfo: LoadingInfo,
      }
    | {
        +type: 'SEND_DELETE_MESSAGE_FAILED',
        +error: true,
        +payload: Error,
        +loadingInfo: LoadingInfo,
      },
