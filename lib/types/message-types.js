...
export type ReplaceMessageStoreThreadOperation = {
  +type: 'replace_thread',
  +payload: { +threads: { +[threadID: string]: ThreadMessageInfo } },
};

export type RemoveMessageStoreThreadOperation = {
  +type: 'remove_thread',
  +payload: { +ids: $ReadOnlyArray<string> },
};
...
export type MessageStoreOperation =
  ...
  | ReplaceMessageStoreThreadOperation
  | RemoveMessageStoreThreadOperation
