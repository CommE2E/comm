...
import { policyTypeValidator, type PolicyType } from '../../facts/policies.js';
import { mixedThinThickThreadInfoValidator } from '../../permissions/minimally-encoded-raw-thread-info-validators.js';
...
export const registerResponseValidator: TInterface<RegisterResponse> =
  tShape<RegisterResponse>({
    ...
    cookieChange: tShape({
      threadInfos: t.dict(tID, mixedThinThickThreadInfoValidator),
...
export const logInResponseValidator: TInterface<ServerLogInResponse> =
  tShape<ServerLogInResponse>({
    ...
    notAcknowledgedPolicies: t.maybe(t.list<PolicyType>(policyTypeValidator)),
  });
