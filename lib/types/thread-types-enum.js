...
export type ThinThreadTypeValues = $Values<typeof thinThreadTypes>;
export const thinThreadTypeValidator: TRefinement<ThinThreadTypeValues> =
  tNumEnum(values(thinThreadTypes));
...
export type ThickThreadTypeValues = $Values<typeof thickThreadTypes>;
export const thickThreadTypeValidator: TRefinement<ThickThreadTypeValues> =
  tNumEnum(values(thickThreadTypes));
...
export type ThreadTypeValues = $Values<typeof threadTypes>;
export const threadTypeValidator: TRefinement<ThreadTypeValues> = tNumEnum(
  values(threadTypes),
);
