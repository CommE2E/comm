...
export const thinThreadTypeValidator: TRefinement<ThinThreadType> = tNumEnum(
...
export const thickThreadTypeValidator: TRefinement<ThickThreadType> = tNumEnum(
...
export const farcasterThreadTypeValidator: TRefinement<FarcasterThreadType> =
  tNumEnum(values(farcasterThreadTypes));
...
export const threadTypeValidator: TRefinement<ThreadType> = tNumEnum(
  values(threadTypes),
);
