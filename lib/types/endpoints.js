...
const endpointsNotRequiringAuthentication = Object.freeze({
...
const endpointsNotRequiringAuthenticationSet = new Set(
  Object.values(endpointsNotRequiringAuthentication),
);
export function endpointRequiresAuthentication(endpoint: Endpoint): boolean {
  return !endpointsNotRequiringAuthenticationSet.has(endpoint);
}
