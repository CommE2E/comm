...
export type DMSendMediaMessageOperation = {
...
export const dmSendMediaMessageOperationValidator: TInterface<DMSendMediaMessageOperation> =
  tShape<DMSendMediaMessageOperation>({
    type: tString(dmOperationTypes.SEND_MEDIA_MESSAGE),
    threadID: t.String,
    creatorID: tUserID,
    time: t.Number,
    messageID: t.String,
...
export const dmOperationValidator: TUnion<DMOperation> = t.union([
  ...
  dmSendMediaMessageOperationValidator,
