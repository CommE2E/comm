...
export type DMChangeRelationshipOperation = {
  +type: 'change_relationship',
  +editorID: string,
  +userID: string,
  +relationship: TraditionalRelationshipAction,
};
export const dmChangeRelationshipOperationValidator: TInterface<DMChangeRelationshipOperation> =
  tShape<DMChangeRelationshipOperation>({
    type: tString(dmOperationTypes.CHANGE_RELATIONSHIP),
    editorID: tUserID,
    userID: tUserID,
    relationship: t.enums.of(traditionalRelationshipActionsList),
  });
...
export const dmOperationValidator: TUnion<DMOperation> = t.union([
  ...
  dmChangeRelationshipOperationValidator,
]);
