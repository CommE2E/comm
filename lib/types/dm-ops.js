...
export type DMSendDeleteMessageOperation = {
...
export const dmSendDeleteMessageOperationValidator: TInterface<DMSendDeleteMessageOperation> =
  tShape<DMSendDeleteMessageOperation>({
    type: tString(dmOperationTypes.SEND_DELETE_MESSAGE),
    threadID: tThickID,
    creatorID: tUserID,
    time: t.Number,
    messageID: tThickID,
...
export const reportUnshimmingOperationCompletedActionType =
  'REPORT_UNSHIMMING_OPERATION_COMPLETED';
export type ReportUnshimmingOperationCompletedPayload = {
  +id: string,
};
...
export type QueuedDMOperations = {
  ...
  +shimmedOperations: $ReadOnlyArray<SaveUnsupportedOperationPayload>,
};
