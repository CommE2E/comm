...
export const pickledOLMAccountValidator: TInterface<PickledOLMAccount> =
  tShape<PickledOLMAccount>({
    picklingKey: t.String,
...
export const notificationsOlmDataTypeValidator: TInterface<NotificationsOlmDataType> =
  tShape<NotificationsOlmDataType>({
    mainSession: t.String,
    picklingKey: t.String,
    pendingSessionUpdate: t.String,
    updateCreationTimestamp: t.Number,
  });
...
export type OlmAPI = {
  ...
  +persistEphemeralKeyserverNotifsSession?: (sessionPersistenceData: {
    +[string]: mixed,
  }) => Promise<void>,
