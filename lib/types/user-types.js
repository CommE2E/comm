...
import { type ProtocolName, protocolNameValidator } from './protocol-names.js';
import {
...
const accountUserInfoValidatorShape = {
  id: tUserID,
  username: t.String,
  relationshipStatus: t.maybe(userRelationshipStatusValidator),
  avatar: t.maybe(clientAvatarValidator),
...
export const accountUserInfoValidator: TInterface<AccountUserInfo> =
  tShape<AccountUserInfo>(accountUserInfoValidatorShape);

export type SelectedUserInfo = {
  ...AccountUserInfo,
  +supportedProtocols: $ReadOnlyArray<ProtocolName>,
};
export const selectedUserInfoValidator: TInterface<SelectedUserInfo> =
  tShape<SelectedUserInfo>({
    ...accountUserInfoValidatorShape,
    supportedProtocols: t.list(protocolNameValidator),
  });
