...
// each userSurfacedPermission and a set of threadPermissions. When a new
// permission is added, if it should be configurable for a role, it should be
// either added to an existing set or a new set and user-facing permission
// should be created. If it is a permission that should be ensured across all
// roles, it should be added to `universalCommunityPermissions`.
...
const voicedPermission = {
  ...
  description: 'Allows members to be voiced in announcement channels',
