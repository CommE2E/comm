...
export const userSurfacedPermissions = Object.freeze({
  EDIT_ENTRIES: 'edit_entries',
  SEE_SECRET_CHANNELS: 'see_secret_channels',
  SPEAK_IN_ANNOUNCEMENT_CHANNELS: 'speak_in_announcement_channels',
...
const calendarEditPermission = {
  ...
  userSurfacedPermission: userSurfacedPermissions.EDIT_ENTRIES,
};
...
const secretChannelsPermission = {
  ...
  userSurfacedPermission: userSurfacedPermissions.SEE_SECRET_CHANNELS,
};
...
const voicedPermission = {
  ...
  userSurfacedPermission:
    userSurfacedPermissions.SPEAK_IN_ANNOUNCEMENT_CHANNELS,
};
...
type ConfigurableCommunityPermission = {
  +[permission: string]: UserSurfacedPermission,
};
export const configurableCommunityPermissions: ConfigurableCommunityPermission =
  Object.freeze({
    [editEntries]: userSurfacedPermissions.EDIT_ENTRIES,
    [descendantEditEntries]: userSurfacedPermissions.EDIT_ENTRIES,
    [descendantKnowOf]: userSurfacedPermissions.SEE_SECRET_CHANNELS,
    [descendantVisible]: userSurfacedPermissions.SEE_SECRET_CHANNELS,
    [voiced]: userSurfacedPermissions.SPEAK_IN_ANNOUNCEMENT_CHANNELS,
    [editThreadName]: userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [descendantEditThreadName]:
      userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [editThreadDescription]: userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [descendantEditThreadDescription]:
      userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [editThreadColor]: userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [descendantEditThreadColor]:
      userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [createSubchannels]: userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [descendantCreateSubchannels]:
      userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [editThreadAvatar]: userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [descendantEditThreadAvatar]:
      userSurfacedPermissions.CREATE_AND_EDIT_CHANNELS,
    [deleteThread]: userSurfacedPermissions.DELETE_CHANNELS,
    [descendantDeleteThread]: userSurfacedPermissions.DELETE_CHANNELS,
    [addMembers]: userSurfacedPermissions.ADD_MEMBERS,
    [descendantAddMembers]: userSurfacedPermissions.ADD_MEMBERS,
    [removeMembers]: userSurfacedPermissions.REMOVE_MEMBERS,
    [descendantRemoveMembers]: userSurfacedPermissions.REMOVE_MEMBERS,
    [changeRole]: userSurfacedPermissions.CHANGE_ROLES,
    [descendantChangeRole]: userSurfacedPermissions.CHANGE_ROLES,
    [editPermissions]: userSurfacedPermissions.EDIT_VISIBILITY,
    [descendantEditPermissions]: userSurfacedPermissions.EDIT_VISIBILITY,
    [managePins]: userSurfacedPermissions.MANAGE_PINS,
    [descendantManagePins]: userSurfacedPermissions.MANAGE_PINS,
    [reactToMessage]: userSurfacedPermissions.REACT_TO_MESSAGES,
    [descendantReactToMessage]: userSurfacedPermissions.REACT_TO_MESSAGES,
    [editMessage]: userSurfacedPermissions.EDIT_MESSAGES,
    [descendantEditMessage]: userSurfacedPermissions.EDIT_MESSAGES,
    [manageInviteLinks]: userSurfacedPermissions.MANAGE_INVITE_LINKS,
