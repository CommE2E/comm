...
export function assertThreadPermissions(
  ...
  invariant(
    ourThreadPermissions === 'know_of' ||
      ...
      ourThreadPermissions === 'manage_farcaster_channel_tags',
...
const addMembersPermissions = new Set([addMembers, childOpenAddMembers]);
...
const manageFarcasterChannelTagsPermission = {
  ...
  description: 'Allows members to create and delete farcaster channel tags',
