...
import { tShape, tString } from '../utils/validation-utils';
...
export const dimensionsValidator: TInterface = tShape({
  height: t.Number,
  width: t.Number,
});
...
export const mediaLibrarySelectionValidator: TUnion<TInterface> = t.union([
  tShape({
    step: tString('photo_library'),
    dimensions: dimensionsValidator,
    filename: t.String,
    uri: t.String,
    mediaNativeID: t.String,
    selectTime: t.Number,
    sendTime: t.Number,
    retries: t.Number,
  }),
...
export const photoCaptureValidator: TInterface = tShape({
...
export const photoPasteValidator: TInterface = tShape({
...
export const nativeMediaSelectionValidator: TUnion<TInterface> = t.union([
...
export const imageValidator: TInterface = tShape({
  id: t.String,
  uri: t.String,
  type: tString('photo'),
  dimensions: dimensionsValidator,
...
export const videoValidator: TInterface = tShape({
  id: t.String,
  uri: t.String,
  type: tString('video'),
  dimensions: dimensionsValidator,
  loop: t.maybe(t.Boolean),
  thumbnailID: t.String,
...
export const mediaValidator: TUnion<TInterface> = t.union([
  imageValidator,
  videoValidator,
]);
