...
type ImageBlobURI = { +holder: string } | { +blobURI: string };
...
const encryptedImageCommonsValidator = tShape({
  blobURI: t.maybe(t.String),
  id: tID,
...
export const encryptedImageValidator: TUnion<EncryptedImage> =
  t.union<EncryptedImage>([
    tShape({ ...encryptedImageCommonsValidator.meta.props, holder: t.String }),
    tShape({ ...encryptedImageCommonsValidator.meta.props, blobURI: t.String }),
  ]);
...
// new format uses blobURI. Effectively, they both mean blob URI
type VideoBlobURI =
  | { +holder: string, +thumbnailHolder: string }
  | { +blobURI: string, +thumbnailBlobURI: string };
...
const encryptedVideoCommonsValidator = tShape({
  id: tID,
  encryptionKey: t.String,
...
export const encryptedVideoValidator: TUnion<EncryptedVideo> =
  t.union<EncryptedVideo>([
    tShape({
      ...encryptedVideoCommonsValidator.meta.props,
      holder: t.String,
