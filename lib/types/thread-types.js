...
export type LegacyFarcasterRawThreadInfo = {
  +farcaster: true,
  +id: string,
  +type: FarcasterThreadType,
  +name?: ?string,
...
export const legacyFarcasterRawThreadInfoValidator: TInterface<LegacyFarcasterRawThreadInfo> =
  tShape<LegacyFarcasterRawThreadInfo>({
    farcaster: tBool(true),
    id: tID,
    type: farcasterThreadTypeValidator,
    name: t.maybe(t.String),
    avatar: t.maybe(clientAvatarValidator),
    description: t.maybe(t.String),
    color: t.String,
