...
import { tID, tShape, tNumEnum } from '../utils/validation-utils';
...
const threadPermissionInfoValidator = t.union([
  tShape({ value: t.refinement(t.Boolean, v => v === true), source: t.String }),
  tShape({ value: t.refinement(t.Boolean, v => v === false), source: t.Nil }),
]);
