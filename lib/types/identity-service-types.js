...
export type ReservedUserIdentities = {
  +[userID: string]: string,
};
export const reservedIdentitiesValidator: TDict<ReservedUserIdentities> =
  t.dict(t.String, t.String);

export type UserIdentitiesResponse = {
  +identities: Identities,
  +reservedUserIdentities: ReservedUserIdentities,
};
export const userIdentitiesResponseValidator: TInterface<UserIdentitiesResponse> =
  tShape<UserIdentitiesResponse>({
    ...
    reservedUserIdentities: reservedIdentitiesValidator,
  });
