...
export type IdentityObject = {
  +username: string,
  +walletAddress: ?EthereumIdentityObject,
  +farcasterID: ?string,
};
export type Identities = {
  +[userID: string]: IdentityObject,
};
export const ethereumIdentityObjectValidator: TInterface<EthereumIdentityObject> =
  tShape<EthereumIdentityObject>({
    walletAddress: t.String,
    siweMessage: t.String,
    siweSignature: t.String,
  });
export const identityObjectValidator: TInterface<IdentityObject> =
  tShape<IdentityObject>({
    username: t.String,
    walletAddress: t.maybe(ethereumIdentityObjectValidator),
